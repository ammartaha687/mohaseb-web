-- MOHASEB CENTRAL SYNC V11
-- Supabase is the single source of truth.
-- No DROP / TRUNCATE / DELETE operations are performed by this migration.
-- The client uses optimistic Compare-and-Swap and performs a three-way merge
-- before retrying a conflicting commit.
